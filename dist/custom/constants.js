...
const incrementBy = /* @__PURE__ */ new Map();
incrementBy.set("c", 2);
incrementBy.set("C", 2);
incrementBy.set("d", 2);
incrementBy.set("D", 2);
...
const INTERVAL_NAMES = ["prime", "second", "third", "fourth", "tritone", "fifth", "sixth", "seventh", "octave"];
const EVENT_TYPES = {
  noteOn: "Note on",
  noteOff: "Note off",
  toggle: "toggle"
...
const SEVENTH_CHORDS = ["majorTriadMinorSeventh", "majorTriadMajorSeventh", "minorTriadMinorSeventh", "minorTriadMajorSeventh", "halfDiminished", "diminishedSeventh"];
const INVERSIONS = {
...
const CHORD_VECTOR_MAP = /* @__PURE__ */ new Map([
