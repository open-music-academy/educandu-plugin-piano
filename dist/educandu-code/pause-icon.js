...
function PauseIcon(props) {
  return /* @__PURE__ */ React.createElement(Icon, { component: PauseIconComponent, ...props });
}
var pause_icon_default = PauseIcon;
export {
  PauseIconComponent,
  pause_icon_default as default
};
