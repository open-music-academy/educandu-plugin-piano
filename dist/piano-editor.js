...
function PianoEditor({ content, onContentChanged }) {
  ...
  const renderMidiTrackTitleInput = (value, onChangeHandler) => /* @__PURE__ */ React.createElement(FormItem, { label: t("common:title"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(Input, { value, onChange: onChangeHandler }));
  const renderSelectorPiano = () => /* @__PURE__ */ React.createElement("div", { className: "Piano-selectorPianoContainer" }, /* @__PURE__ */ React.createElement("div", { className: "Piano-selectorPianoWrapper" }, /* @__PURE__ */ React.createElement("div", null, t("keyRangeSelectionText")), /* @__PURE__ */ React.createElement("div", { className: "Piano-selectorPiano" }, pianoLayout.map((elem, index) => {
    ...
    return /* @__PURE__ */ React.createElement(KeyWhite, { updateKeyRangeSelection, key: id.create(), midiValue: elem[1], index, colors: selectorPianoColors });
  })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Button, { onClick: handleKeyRangeChanged }, t("common:confirm")))));
  const renderKeyRangeSelector = (onClickHandler) => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(FormItem, { label: t("pianoKeyRange"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(Button, { onClick: onClickHandler }, ". . .")), !!canRenderSelectorPiano && renderSelectorPiano());
  const renderWhiteKeysCheckbox = (index) => /* @__PURE__ */ React.createElement(
    Checkbox,
    {
  ...
  const renderNoteRangeSelector = (testIndex, onAfterChangeHandler, noteRange, index) => {
    return /* @__PURE__ */ React.createElement(FormItem, { label: t("noteRange"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(
      Slider,
      {
        min: 0,
        max: 51,
  ...
  const renderClefTypeSelector = (testIndex, clef, onChangeHandler, index) => /* @__PURE__ */ React.createElement(FormItem, { label: t("clef"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(RadioGroup, { value: clef }, /* @__PURE__ */ React.createElement(RadioButton, { value: "treble", onChange: (event) => onChangeHandler(event, testIndex, index) }, t("trebleClef")), /* @__PURE__ */ React.createElement(RadioButton, { value: "bass", onChange: (event) => onChangeHandler(event, testIndex, index) }, t("bassClef"))));
  const renderIntervalSelector = (checkboxStates, exerciseType, testIndex) => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(FormItem, { label: t("intervals"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(
    Checkbox,
    {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: id.create() }, /* @__PURE__ */ React.createElement(
      Checkbox,
      {
      ...
      t(interval)
    ), [1, 2, 6, 7].includes(index) && !tests[testIndex].whiteKeysOnly && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      Checkbox,
      {
  ...
  })), /* @__PURE__ */ React.createElement(FormItem, { label: t("largeIntervals"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(
    Checkbox,
    {
      defaultChecked: tests[testIndex][`${exerciseType}AllowsLargeIntervals`],
      onChange: (event) => {
        handleLargeIntervalsCheckboxStateChanged(event, testIndex);
      }
    },
    t("intervalsPlusOctave")
  )), exerciseType === EXERCISE_TYPES.interval && /* @__PURE__ */ React.createElement(FormItem, { label: t("direction"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(
    Checkbox,
    {
  ...
  const renderChordSelector = (index) => /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(FormItem, { label: t("options"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(
    Checkbox,
    {
      key: id.create(),
    ...
    t("all")
  )), /* @__PURE__ */ React.createElement(FormItem, { label: t("triads"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement("div", null, Object.keys(TRIADS).map((triad) => /* @__PURE__ */ React.createElement(
    Checkbox,
    {
      key: id.create(),
    ...
    t(triad)
  )))), /* @__PURE__ */ React.createElement(FormItem, { label: t("seventhChords"), ...FORM_ITEM_LAYOUT }, SEVENTH_CHORDS.map((chord) => /* @__PURE__ */ React.createElement("div", { key: id.create() }, /* @__PURE__ */ React.createElement(
    Checkbox,
    {
    ...
    t(chord)
  )))), /* @__PURE__ */ React.createElement(FormItem, { label: t("inversions"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement("div", null, Object.keys(INVERSIONS).map((inversion) => /* @__PURE__ */ React.createElement(
    Checkbox,
    {
      key: id.create(),
    ...
    Checkbox,
    {
      ...
      onChange: (event) => {
        handleLargeIntervalsCheckboxStateChanged(event, index);
      }
    },
    t("allowLargeIntervals")
  )));
  const renderNoteSequenceTypeSelector = (index) => /* @__PURE__ */ React.createElement(FormItem, { label: t("type"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(RadioGroup, { value: tests[index].isCustomNoteSequence }, /* @__PURE__ */ React.createElement(RadioButton, { value: false, onChange: (event) => handleNoteSequenceTypeChanged(event, index) }, t("random")), /* @__PURE__ */ React.createElement(RadioButton, { value: true, onChange: (event) => handleNoteSequenceTypeChanged(event, index) }, t("predefined"))));
  const renderCustomNoteSequencePanels = (testIndex) => {
    return tests[testIndex].customNoteSequences.map((noteSequence, index) => /* @__PURE__ */ React.createElement(
      ItemPanel,
      {
        index,
        key: id.create(),
  ...
  const renderNoteSequenceSelector = (numberOfNotes, index) => {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, !tests[index].isCustomNoteSequence && /* @__PURE__ */ React.createElement(FormItem, { label: t("numberOfNotes"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(
      Slider,
      {
        min: 3,
        max: 10,
    ...
    )), !tests[index].isCustomNoteSequence && renderIntervalSelector(tests[index].noteSequenceCheckboxStates, EXERCISE_TYPES.noteSequence, index), !!tests[index].isCustomNoteSequence && renderCustomNoteSequencePanels(index), !!tests[index].isCustomNoteSequence && /* @__PURE__ */ React.createElement(Button, { type: "primary", icon: /* @__PURE__ */ React.createElement(PlusOutlined, null), onClick: () => handleAddCustomNoteSequenceButtonClick(index) }, t("addCustomNoteSequence")));
  };
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Form, { layout: "horizontal", labelAlign: "left" }, renderKeyRangeSelector(toggleSelectorPiano), /* @__PURE__ */ React.createElement(Divider, null, "MIDI"), renderMidiTrackTitleInput(midiTrackTitle, handleMidiTrackTitleValueChanged), /* @__PURE__ */ React.createElement(FormItem, { ...FORM_ITEM_LAYOUT, label: t("common:url") }, /* @__PURE__ */ React.createElement(UrlInput, { value: sourceUrl, onChange: handleSourceUrlChange })), /* @__PURE__ */ React.createElement(Divider, { plain: true }, t("earTraining")), tests.map((test, index) => /* @__PURE__ */ React.createElement(
    ItemPanel,
    {
      index,
      key: id.create(),
    ...
    /* @__PURE__ */ React.createElement(FormItem, { label: t("exerciseType"), ...FORM_ITEM_LAYOUT }, /* @__PURE__ */ React.createElement(RadioGroup, { onChange: (event) => handleExerciseTypeValueChanged(event, index), value: test.exerciseType }, /* @__PURE__ */ React.createElement(RadioButton, { value: EXERCISE_TYPES.interval }, t("interval")), /* @__PURE__ */ React.createElement(RadioButton, { value: EXERCISE_TYPES.chord }, t("chord")), /* @__PURE__ */ React.createElement(RadioButton, { value: EXERCISE_TYPES.noteSequence }, t("noteSequence")))),
  ...
  ))), /* @__PURE__ */ React.createElement(Button, { type: "primary", icon: /* @__PURE__ */ React.createElement(PlusOutlined, null), onClick: handleAddTestButtonClick }, t("earTraining:addTest")));
}
PianoEditor.propTypes = {
  ...sectionEditorProps
};
export {
  PianoEditor as default
};
//# sourceMappingURL=piano-editor.js.map
